...
<cfset content.subCategoryMenu = application.menuObj.displaySubCategoryMenu(cat_id=attributes.cat_id,subcat_id=attributes.subcat_id) >
<cfset content.mainContent = application.contentObj.displayProductList(cat_id=attributes.cat_id,subcat_id=attributes.subcat_id,cat3_id=attributes.cat3_id,keyword=attributes.keyword) >
