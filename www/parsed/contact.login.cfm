...
<cfset attributes.loginSuccess = application.contactObj.loginCheck(argumentCollection=attributes) >
</cfif>
<cfif not isDefined("attributes.loginSuccess")><cfset attributes.loginSuccess = "0" /></cfif>
<cfset content.mainContent = application.contactObj.displayLoginForm(attributes.loginSuccess) >
