...
<cfset myFusebox.thisFuseaction = "saved">
...
<cfset application.contactObj.sendProductContact(argumentCollection=attributes) >
</cfif>
<cfif isDefined('attributes.delete')>
<cfset application.contentObj.deleteSavedProduct(argumentCollection=attributes) >
</cfif>
<cfset content.mainContent = application.contentObj.productsSaved(cookie.gdrProductList) >
