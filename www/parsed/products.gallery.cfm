...
<cfset myFusebox.thisFuseaction = "gallery">
...
<cfset attributes.gal_id = "9" />
<cfif not isDefined("attributes.img_id")><cfset attributes.img_id = "0" /></cfif>
<cfset attributes.displayMode = "gallery" />
<cfset content.mainContent = application.imageObj.galleryImageView(attributes.gal_id,attributes.img_id) >
