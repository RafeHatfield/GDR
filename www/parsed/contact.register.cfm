...
<cfset attributes.registerSuccess = application.contactObj.registerSave(argumentCollection=attributes) >
</cfif>
<cfif not isDefined("attributes.registerSuccess")><cfset attributes.registerSuccess = "0" /></cfif>
<cfset content.mainContent = application.contactObj.register(attributes.registerSuccess) >
