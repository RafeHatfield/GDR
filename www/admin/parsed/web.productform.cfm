...
<cfset myFusebox.thisFuseaction = "productForm">
<cfset xfa.saveProduct = "web.productForm" />
<cfif not isDefined("attributes.prd_id")><cfset attributes.prd_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset application.contentObj.productSave(argumentCollection=attributes) >
<cflocation url="#myself#web.productList&cat_id=#attributes.prd_category#&subcat_id=#prd_subCategory#" addtoken="false">
<cfabort>
</cfif>
<cfset qProduct = application.contentObj.getProduct(prd_id=attributes.prd_id) >
<cfset qCategories = application.menuObj.getCategories() >
<cfset qSubCategories = application.menuObj.getAllSubCategories() >
<cfset qCategories3 = application.menuObj.getAllCategories3() >
<cfif qProduct.recordCount gte 1>
<cfset attributes.prd_title = "#qProduct.prd_title#" />
<cfset attributes.prd_code = "#qProduct.prd_code#" />
<cfset attributes.prd_desc = "#qProduct.prd_desc#" />
<cfset attributes.prd_colour = "#qProduct.prd_colour#" />
<cfset attributes.prd_order = "#qProduct.prd_order#" />
<cfset attributes.prd_active = "#qProduct.prd_active#" />
<cfset attributes.prd_dimension = "#qProduct.prd_dimension#" />
<cfset attributes.prd_category = "#qProduct.prd_category#" />
<cfset attributes.prd_subcategory = "#qProduct.prd_subcategory#" />
<cfset attributes.prd_category3 = "#qProduct.prd_category3#" />
<cfelse>
<cfset attributes.prd_title = "" />
<cfset attributes.prd_code = "" />
<cfset attributes.prd_desc = "" />
<cfset attributes.prd_colour = "" />
<cfset attributes.prd_order = "" />
<cfset attributes.prd_active = "1" />
<cfset attributes.prd_dimension = "" />
<cfset attributes.prd_category = "0" />
<cfset attributes.prd_subcategory = "0" />
<cfset attributes.prd_category3 = "0" />
</cfif>
<!--- do action="v_web.productForm" --->
<cfset myFusebox.trace("Runtime","&lt;do action=""v_web.productForm""/&gt;") >
<cfset myFusebox.thisCircuit = "v_web">
<cfparam name="content.mainContent" default="">
<cfsavecontent variable="content.mainContent">
<cfoutput>#content.mainContent#</cfoutput>
<cfset myFusebox.trace("Runtime","&lt;include template=""dsp_productForm.cfm"" circuit=""v_web""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../web/view/dsp_productForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "dsp_productForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_productForm.cfm in circuit v_web which does not exist (from fuseaction v_web.productForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
</cfsavecontent>
