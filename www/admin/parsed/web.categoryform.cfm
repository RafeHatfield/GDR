...
<cfset myFusebox.thisFuseaction = "categoryForm">
<cfif not isDefined("attributes.cat_id")><cfset attributes.cat_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset application.contentObj.categorySave(argumentCollection=attributes) >
<cflocation url="#myself#web.categoryList" addtoken="false">
<cfabort>
</cfif>
<cfset content.mainContent = application.contentObj.displayCategoryForm(cat_id=attributes.cat_id) >
