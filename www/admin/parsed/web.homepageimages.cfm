...
<cfset myFusebox.thisFuseaction = "homePageImages">
<cfif isDefined('attributes.save')>
<cfset application.imageObj.homePageImagesSave(argumentCollection=attributes) >
</cfif>
<cfset content.mainContent = application.imageObj.homePageImagesForm() >
