...
<cfset myFusebox.thisFuseaction = "categoryList">
<cfif not isDefined("attributes.cat_level")><cfset attributes.cat_level = "0" /></cfif>
<cfset categorySearchForm = "" />
<cfset categoryOrderForm = "" />
<cfset categorySearchForm = application.contentObj.categorySearchForm(attributes.cat_level) >
<cfif isDefined('attributes.save')>
<cfset application.contentObj.categoryOrderSave(argumentCollection=attributes) >
</cfif>
<cfif isDefined('attributes.search')>
<cfset categoryOrderForm = application.contentObj.categoryOrderListForm(attributes.cat_level) >
</cfif>
<cfset content.mainContent = "#categorySearchForm##categoryOrderForm#" />
